...
void UnifiedParticleTransformerAK4ONNXJetTagsProducer::make_inputs(
  ...
  // c_pf candidates
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kChargedCandidates, features.c_pf_features, max_c_pf_n, start, offset);
  // lt candidates
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kLostTracks, features.lt_features, max_lt_n, start, offset);
  // n_pf candidates
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kNeutralCandidates, features.n_pf_features, max_n_pf_n, start, offset);
  // sv candidates
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kVertices, features.sv_features, max_sv_n, start, offset);
  // cpf pairwise features (4-vectors)
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kChargedCandidates4Vec, features.c_pf_features, max_c_pf_n, start, offset);
  // lt pairwise features (4-vectors) specific case requiring (pt,eta,phi,e)
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kLostTracks4Vec, features.lt_features, max_lt_n, start, offset);
  // npf pairwise features (4-vectors)
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kNeutralCandidates4Vec, features.n_pf_features, max_n_pf_n, start, offset);
  // sv pairwise features (4-vectors)
  btagbtvdeep::UParT_tensor_filler(data_, UparT::kVertices4Vec, features.sv_features, max_sv_n, start, offset);
}
